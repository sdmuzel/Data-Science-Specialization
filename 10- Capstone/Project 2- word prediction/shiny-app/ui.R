...
shinyUI(
    navbarPage("Next Word Predict",
               ...
               tabPanel("About",
                        ...
                        h3("About Me"),
                        br(),
                        div("My name is Sarah and I am a
                            PhD Student in ",
                            a(target = "_blank", href = "https://www2.unesp.br/", "Unesp"),".",
                            "I am study composite materials.",
                            br(),
                            br(),
                            "My work includes find a batter parameter for a holes in the material, of usin n the airplane.",
                            br(),
                            br(),
                            "This is my first specialization.",
                            br(),
                            br(),
                            "I graduated at Unsp in enginnering.",
                            br(),
                            br(),
                            img(src = "linkedin.png"),
                            a(target = "_blank", href="https://www.linkedin.com/in/sarah-david-m%C3%BCzel-05525356/", "linkedin"),
                            br(),
                            img(src = "twitter.png"),
                            a(target = "_blank", href="https://twitter.com/home", "Twitter"))
               )
    )
)
